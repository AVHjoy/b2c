...
describe('Pré-cadastro', () => {
    ...
    it('deve realizar cadastro PJ com sucesso', () => {
        ...
        //Step 1
        cy.get('#approval-process-start-step-input-registration-type').select('2');
        cy.get('#next-button').click();

        //Step 2
        cy.get(':nth-child(3) > :nth-child(1) > .relative > .p-2\.5').type(faker.br.cnpj());
        cy.get('#cpf-field > .relative > .p-2\.5').type(faker.br.cpf());
