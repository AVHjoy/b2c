...
describe('Pré-cadastro', () => {
    ...
    it('deve realizar cadastro PJ com sucesso', () => {
        cy.visit('/');
        cy.switchLanguage('Português', 0);
        ...
        //Step 2
        cy.get('/html/body/div[1]/div[1]/div[3]/div/div[2]/div/div[2]/div/div/div/div[3]/div/div/input').type((Math.floor(100000000 + Math.random() * 900000000)).toString());
        cy.get('/html/body/div[1]/div[1]/div[3]/div/div[2]/div/div[2]/div/div/div/div[5]/div/div/input').type((Math.floor(100000000 + Math.random() * 900000000)).toString());
